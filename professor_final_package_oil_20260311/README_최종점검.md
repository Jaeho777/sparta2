...
- Transformer 심화 노트북: [ipynb/02_oil_transformer_advanced.ipynb](/Users/jaeholee/Desktop/T-LAB/sparta_2/sparta2/professor_final_package_oil_20260311/ipynb/02_oil_transformer_advanced.ipynb)
- STL 보조 노트북: [ipynb/03_oil_stl_residual_ror.ipynb](/Users/jaeholee/Desktop/T-LAB/sparta_2/sparta2/professor_final_package_oil_20260311/ipynb/03_oil_stl_residual_ror.ipynb)
...
- 완료: 공통 반복 검증 CSV가 포함되어 있다.
- 완료: 보고서와 노트북에서 `단일 분할 결과`와 `공통 반복 검증 결과`를 구분해서 설명한다.
...
- `02_oil_transformer_advanced.ipynb`에서 공통 반복 검증 표 출력이 보이는지 확인
- `03_oil_stl_residual_ror.ipynb`에서 공통 반복 검증 표 출력이 보이는지 확인
