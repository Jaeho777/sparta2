...
![그림 1. 기준 성능 재현 노트북의 시험 구간 실제값과 예측값](report_figures/01_baseline_test_predictions.png)
...
![그림 2. Transformer 노트북의 SHAP 중요도와 변수 수 선택 결과](report_figures/02_transformer_feature_selection.png)
...
![그림 3. Transformer 노트북의 시험 구간 실제값과 핵심 조합 예측값](report_figures/03_transformer_test_predictions.png)
...
![그림 4. STL 단계 설명 노트북의 시험 구간 실제값과 단계별 예측값](report_figures/04_stl_final_comparison.png)
...
![그림 5. 추가 점검용 반복 평가의 평균 시험 RMSE 비교](report_figures/05_repeated_mean_test_rmse.png)
